...
class ExtractTweets:
    ...
    def get_tweet_df(self, save=False)->pd.DataFrame:
        ...
        if save:
            df.to_csv('D:/MCS 4.1/SAT in CS/Twitter-Data-Analysis/data/processed_tweet_data.csv', index=False)
...
if __name__ == "__main__":
    ...
    extracted_tweets = ExtractTweets("D:/MCS 4.1/SAT in CS/Twitter-Data-Analysis/data/Economic_Twitter_Data_minified.json")
